...
if (!isset($_GET['order_id'])) {
    ...
    // جلب بيانات الأوردر مع اسم العميل
    $order_sql = "
    ...
    // تأكد إن الأوردر موجود في الداتابيز
    if ($order_res->num_rows == 0) {
        ...
        // جلب تفاصيل المنتجات داخل الأوردر
        $items_sql = "
...
<head>
    ...
    <title>Order Detail #<?= htmlspecialchars($order_id ?? 'Error') ?> | Admin</title>
    <style>
        /* =========================================
...
<div class="glass-panel fade-in">
    ...
    <?php else: ?>
        <h2>Order Details <span>#<?= $order['Order_ID'] ?></span></h2>
        ...
        <div class="order-meta">
            ...
            <div class="meta-item">
                ...
                <p style="color: #10b981;"><?= htmlspecialchars($order['Status']) ?></p>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="color: #fff; font-weight: 500;"><?= htmlspecialchars($item['Product_Name']) ?></td>
